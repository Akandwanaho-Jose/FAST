...
$groups = [
    ...
    'navigation' => [
        ...
        ['navigation.research', 'Research and Innovation label', 'Research & Innovation', 'text'],
        ...
        ['navigation.news_events', 'News and Events label', 'News & Events', 'text'],
    ...
    'homepage' => [
        ...
        ['home.hero_announcements_title', 'Hero announcements heading', 'Announcements', 'text'],
        ['home.hero_announcements_empty', 'Hero announcements empty message', 'No current announcements.', 'text'],
        ...
        ['home.updates_notices_title', 'Notice panel title', 'Notice board', 'text'],
